...
export default function Hero() { // h - acts as a function, H - acts as a component
  return (
    <div className=''>
        ...
        <button className='font-mono border-2 rounded px-6 py-2  bg-[#031526] text-white border-[#26a3d9] hover:bg-[#26a3d9] hover:text-black transition duration-200 '>Copy</button>
        </div>
